...
from agent.DUE import DUE
from agent.DDQN import DDQN
from agent.MaxminDQN import MaxminDQN
from agent.AveragedDQN import AveragedDQN
from agent.MaxminDQNV2 import MaxminDQNV2
import os, shutil
from datetime import datetime
import argparse
from env.utils_env import MyEnv
from env.MiniAtar import AtarEnv
...
print(device)
print(getTimeNow())
fname = opt. env_name[:2]+ opt.agent + "net" + str(opt.net_num) +"set" +str(opt.set_num) +getTimeNow() +opt.fix +".txt"
